...
const rpcUrl = process.env.ROBINHOOD_REDACT_RPC_URL || "";
const privateKey = process.env.ROBINHOOD_REDACT_PRIVATE_KEY || "";
...
if (rpcUrl) {
  try {
    ...
    // Exact-string redaction above still protects malformed/custom provider URLs.
  }
}
